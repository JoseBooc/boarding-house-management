<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Maintenance Request</h2>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.maintenance.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input name="title" class="mt-1 block w-full rounded-md border-gray-300" required />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Description</label>
                            <textarea name="description" rows="4" class="mt-1 block w-full rounded-md border-gray-300" required></textarea>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
