                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="name" class="mt-1 block w-full rounded-md border-gray-300" required />
                            </div>
                            <div>
                        ...
                        <div class="pt-4">
                            <a href="{{ route('admin.users.index') }}" class="inline-flex items-center px-4 py-2 mr-3 border border-gray-300 rounded-md text-sm text-gray-700 bg-white hover:bg-gray-50">Cancel</a>
